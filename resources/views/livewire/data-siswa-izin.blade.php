<div>
    <div class="card">
        <div class="card-header bg-orange">
            <h3 class="text-white">Table Izin Siswa</h3>
        </div>
        ...
        <div class="card-body">
            ...
            @endphp
                <tr>
                    ...
                    <td>
                        <a wire:click.prevent="deleteCustomIzin({{ $data->id }})" class="btn bg-red btn-sm"><i class="bi bi-trash3-fill"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
