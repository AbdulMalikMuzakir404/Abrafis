<!DOCTYPE html>
<html lang="en" ng-app="Application_TimeOut">
<head>
  <meta charset="utf-8">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                              <i class="nav-icon bi bi-battery-half"></i>
                              <p>
                                XI RPL
                                <i class="fas fa-angle-left right"></i>
                              </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                              <i class="nav-icon bi bi-battery-full"></i>
                              <p>
                                XII RPL
                                <i class="fas fa-angle-left right"></i>
                              </p>
...
{{-- plugin js otomatis logout --}}
<script src="http://cdnjs.cloudflare.com/ajax/libs/angular.js/1.2.20/angular.min.js"></script>
</body>
{{-- script js otomatis logout --}}
{{-- <script>
