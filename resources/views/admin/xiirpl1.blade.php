...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Data Siswa RPL</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
          <li class="breadcrumb-item active">Rekayasa Perangkat Lunak</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->

    <livewire:xiirpl1></livewire:xiirpl1>
    <livewire:data-siswa></livewire:data-siswa>
    <livewire:data-siswa-sakit></livewire:data-siswa-sakit>
    <livewire:data-siswa-izin></livewire:data-siswa-izin>
    <livewire:data-siswa-alfa></livewire:data-siswa-alfa>
@endsection
