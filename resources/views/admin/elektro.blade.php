...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Data Siswa Elektro</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
          <li class="breadcrumb-item active">Elektro</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->

    <livewire:elektro.elektro></livewire:elektro.elektro>
    <livewire:elektro.data-hadir-elektro>
    <livewire:elektro.data-sakit-elektro>
    <livewire:elektro.data-izin-elektro>
    <livewire:elektro.data-alfa-elektro>
